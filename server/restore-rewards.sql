...
SET 
  ...
  inventory = json('{golden_egg:50,normal_egg:30,oran_berry:99,sitrus_berry:50,mild_soap:99,aroma_bubble:50,toy_ball:99,plush_doll:50,energy_drink:99,max_potion:30}'),
  coins = 10000,
  statusMsg = '👑 [VVIP] 시공을 초월해 돌아온 불사조 트레이너 ✨',
